					...
					<div class="portlet light">
						...
						<div class="portlet-body">
							...
							<tr>
                                ...
                                <td><a href="<?php echo base_url().'facturas/detalle/'.$row['pagosID'];?>" title="Detalle de <?php echo $row['nombre'] ?> <?php echo $row['apellido'] ?>" class="btn btn-xs default"><i class="fa fa-search"></i> Ver</a></td>
							</tr>
							 <?php endforeach ?>
							</tbody>
							</table>
