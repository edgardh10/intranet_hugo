								...
								<div class="tab-content">
									<div class="tab-pane active" id="tab_6_1">
										<div class="alert alert-warning">
											<strong><h2>Soporte para hoy <?php echo date('d/m/Y'); ?></h2></strong>
										</div>
										<div class="portlet-body">
	                                        <?php
									...
									<div class="tab-pane fade" id="tab_6_3">
                                    	<div class="alert alert-success">
	                                        <h2>Soporte Solucionado</h2>
	                                    </div>
										<div class="portlet-body">
											<table class="table table-striped table-bordered table-hover" id="sample_6" style="width: 100%;">
												<thead>
													<tr>
						                            	<th> </th>
						                                <th> Orden</th>
