							...
							<form class="form-horizontal" method="post" name="generar_factura" action="<?php echo base_url();?>gestion/ingresar_venta/">
                                <div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-icon">
											...
											<input type="text" class="form-control" name="v_nombre" value="<?php echo $row['v_nombre']; ?>">
										</div>
									</div>
								</div>
                                <div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-icon">
											<i class="fa fa-user"></i>
											<input type="text" name="v_apellido" class="form-control" value="<?php echo $row['v_apellido']; ?>">
										</div>
									</div>
								</div>
                                <div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-icon">
											...
											<input type="text" name="v_dni" class="form-control" value="<?php echo $row['v_dni']; ?>">
										</div>
									</div>
								</div>
                                <div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-icon">
											...
											<input type="text" name="v_telefono" class="form-control" value="<?php echo $row['v_telefono']; ?>">
										</div>
									</div>
								</div>
                                <div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-icon">
											...
											<input type="text" name="v_direccion" class="form-control" value="<?php echo $row['v_direccion']; ?>">
										</div>
									</div>
								</div>
                                <div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <span class="input-group-addon">
										...
										<input type="text" name="v_fecha" value="<?php echo $row['v_fecha']; ?>" class="form-control form-control-inline input-medium date-picker todo-taskbody-due" readonly>
									</div>
								</div>
                                <div class="form-group">
									<div class="col-md-offset-2 col-md-10">
										<input type="hidden" name="ventasID" value="<?php echo $row['ventasID']; ?>" />
